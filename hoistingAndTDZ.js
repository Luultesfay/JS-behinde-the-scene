...
var addExpre = function (a, b) { // we get the result typeError addExp is not a function the reason is any variable decleared with var will be hoisted and set to undefined  and then we try to call the undefined 
    return a + b;
};

var addArrow = (a, b) => a + b;//hoisted to undefined the same as the above code
